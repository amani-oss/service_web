 ...
 * generated in the com.calculator.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Subtract_QNAME = new QName("http://calculator.com/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://calculator.com/", "subtractResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.calculator.client
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://calculator.com/", name = "subtract")
     ...
     */
    @XmlElementDecl(namespace = "http://calculator.com/", name = "subtractResponse")
